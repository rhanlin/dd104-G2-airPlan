...
/* 動態產生我的歷史信件 */
function myLetter(myLet, letTitle, letTime, letNo) {
  myLet += `
...
/* 動態產生撈的歷史信件 */
function otherLetter(otherLet, letTitle, letTime, letNo) {
  otherLet += `
      <div class="cav-letters ">
      <div class="cav-letWord">
        <div>
...
function letterContent(fullLet) {
  $(".cav-letters").on("click", function () {
    let letTit = $(this).find(".cav-letTitle").text();
    // console.log(letTit);
    // console.log(fullLet)
